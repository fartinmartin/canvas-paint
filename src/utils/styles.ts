...
export function createStyles(
	...
	styleSheet.sheet!.insertRule(`.${id} { overflow: hidden; }`); // prettier-ignore
	styleSheet.sheet!.insertRule(`.${id} { max-width: ${options.width}px; max-height: ${options.height}px; }`); // prettier-ignore
	styleSheet.sheet!.insertRule(`.${id} { aspect-ratio: ${options.width} / ${options.height}; }`); // prettier-ignore
